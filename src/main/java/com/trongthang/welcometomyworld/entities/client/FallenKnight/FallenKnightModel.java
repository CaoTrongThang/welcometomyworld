...
public class FallenKnightModel<T extends FallenKnight> extends SinglePartEntityModel<T> {
        ...
        public static final EntityModelLayer FALLEN_KNIGHT = new EntityModelLayer(
                        Identifier.of(WelcomeToMyWorld.MOD_ID, "fallen_knight"), "main");
        ...
        public static TexturedModelData getTexturedModelData() {
                ...
                ModelPartData middle_body = body.addChild("middle_body", ModelPartBuilder.create().uv(0, 0)
                                .cuboid(-4.0F, -4.0F, 0.0F, 8.0F, 12.0F, 5.0F, new Dilation(0.0F))
                                .uv(16, 26).cuboid(-4.0F, -0.5F, 3.5F, 8.0F, 8.0F, 2.0F, new Dilation(0.0F)),
                                ModelTransform.pivot(0.0F, -17.0F, 0.0F));

                ModelPartData cube_r1 = middle_body.addChild("cube_r1",
                                ModelPartBuilder.create().uv(48, 0).cuboid(-4.0F, -2.0F, -1.0F, 8.0F, 2.0F, 1.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(0.0F, 5.0F, 0.75F, 0.1745F, 0.0F, 0.0F));

                ModelPartData cube_r2 = middle_body.addChild("cube_r2",
                                ModelPartBuilder.create().uv(0, 59).cuboid(-1.0F, -2.0F, -3.0F, 1.0F, 2.0F, 5.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(4.75F, 5.0F, 3.0F, 0.0F, 0.0F, -0.2618F));

                ModelPartData cube_r3 = middle_body.addChild("cube_r3",
                                ModelPartBuilder.create().uv(16, 56).cuboid(0.0F, -2.0F, -3.0F, 1.0F, 2.0F, 5.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(-4.75F, 5.0F, 3.0F, 0.0F, 0.0F, 0.2618F));
                ...
                ModelPartData cube_r9 = cape.addChild("cube_r9",
                                ModelPartBuilder.create().uv(0, 26).cuboid(-4.0F, -2.0F, -1.0F, 8.0F, 19.0F, 0.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(0.0F, 2.0F, 2.5F, 0.0436F, 0.0F, 0.0F));

                ModelPartData left_hand = middle_body.addChild("left_hand", ModelPartBuilder.create().uv(32, 46)
                                .cuboid(0.0F, -1.0F, -2.0F, 4.0F, 3.0F, 4.0F, new Dilation(0.0F))
                                .uv(48, 3).cuboid(-0.25F, 2.0F, -1.0F, 3.0F, 3.0F, 2.0F, new Dilation(0.0F)),
                                ModelTransform.pivot(4.0F, -4.0F, 2.5F));

                ModelPartData bone2 = left_hand.addChild("bone2", ModelPartBuilder.create().uv(32, 37)
                                .cuboid(0.0F, -1.0F, -2.0F, 4.0F, 5.0F, 4.0F, new Dilation(0.0F))
                                .uv(28, 21).cuboid(0.25F, 4.0F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)),
                                ModelTransform.pivot(-0.25F, 5.0F, 0.0F));

                ModelPartData right_hand_parent = middle_body.addChild("right_hand_parent", ModelPartBuilder.create(),
                                ModelTransform.pivot(-4.0F, -4.0F, 2.5F));

                ModelPartData hammer = right_hand_parent.addChild("hammer", ModelPartBuilder.create().uv(25, 116)
                                .cuboid(-3.0F, -26.0F, -7.0F, 6.0F, 7.0F, 5.0F, new Dilation(0.0F))
                                ...
                                .uv(15, 100).cuboid(-1.0F, -26.0F, -1.0F, 2.0F, 24.0F, 2.0F, new Dilation(0.0F)),
                                ModelTransform.of(-13.0F, 21.0F, -2.5F, 0.0F, 1.5708F, 0.0F));

                ModelPartData cube_r10 = hammer.addChild("cube_r10",
                                ModelPartBuilder.create().uv(87, 125).cuboid(-3.0F, -1.0F, -1.0F, 6.0F, 1.0F, 1.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(0.0F, -21.25F, 1.25F, 0.1309F, 0.0F, 0.0F));

                ModelPartData cube_r11 = hammer.addChild("cube_r11",
                                ModelPartBuilder.create().uv(88, 122).cuboid(-3.0F, -1.0F, -1.0F, 6.0F, 1.0F, 1.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(0.0F, -23.0F, -0.75F, -0.3054F, 0.0F, 0.0F));

                ModelPartData right_hand = right_hand_parent.addChild("right_hand", ModelPartBuilder.create().uv(45, 46)
                                .cuboid(-4.0F, -1.0F, -2.0F, 4.0F, 3.0F, 4.0F, new Dilation(0.0F))
                                .uv(52, 32).cuboid(-2.75F, 2.0F, -1.0F, 3.0F, 3.0F, 2.0F, new Dilation(0.0F)),
                                ModelTransform.pivot(0.0F, 0.0F, 0.0F));

                ModelPartData bone = right_hand.addChild("bone", ModelPartBuilder.create().uv(36, 28)
                                .cuboid(-4.0F, -1.0F, -2.0F, 4.0F, 5.0F, 4.0F, new Dilation(0.0F))
                                .uv(28, 17).cuboid(-2.25F, 4.0F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)),
                                ModelTransform.pivot(0.25F, 5.0F, 0.0F));

                ModelPartData head = middle_body
                                .addChild("head",
                                                ModelPartBuilder.create().uv(26, 8).cuboid(-2.5F, -4.0F, -2.0F, 5.0F,
                                                                4.0F, 5.0F, new Dilation(0.0F)),
                                                ModelTransform.pivot(0.0F, -4.0F, 2.0F));

                ModelPartData helmet = head.addChild("helmet", ModelPartBuilder.create(),
                                ModelTransform.pivot(0.0F, -1.0F, 2.5F));

                ModelPartData top = helmet.addChild("top", ModelPartBuilder.create().uv(0, 17)
                                .cuboid(-3.5F, -5.0F, -5.5F, 7.0F, 2.0F, 7.0F, new Dilation(0.0F))
                                .uv(16, 36).cuboid(-3.5F, -3.0F, -5.5F, 1.0F, 4.0F, 7.0F, new Dilation(0.0F))
                                .uv(36, 17).cuboid(2.5F, -3.0F, -5.5F, 1.0F, 4.0F, 7.0F, new Dilation(0.0F)),
                                ModelTransform.pivot(0.0F, 0.0F, 0.0F));

                ModelPartData down = helmet.addChild("down", ModelPartBuilder.create().uv(46, 8)
                                .cuboid(-6.5F, -3.0F, -5.0F, 8.0F, 3.0F, 1.0F, new Dilation(0.0F))
                                ...
                                .uv(28, 53).cuboid(0.5F, -3.0F, -4.0F, 1.0F, 3.0F, 5.0F, new Dilation(0.0F)),
                                ModelTransform.of(2.5F, 0.75F, -0.5F, 0.1745F, 0.0F, 0.0F));

                ModelPartData left_leg = body
                                .addChild("left_leg",
                                                ModelPartBuilder.create().uv(48, 37).cuboid(-1.5F, 0.0F, 0.0F, 3.0F,
                                                                5.0F, 3.0F, new Dilation(0.0F)),
                                                ModelTransform.pivot(2.5F, -9.0F, 1.0F));

                ModelPartData cube_r12 = left_leg.addChild("cube_r12",
                                ModelPartBuilder.create().uv(60, 37).cuboid(-1.0F, -2.0F, 0.0F, 3.0F, 2.0F, 1.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(-0.5F, 5.75F, -0.25F, 0.2618F, 0.0F, 0.0F));

                ModelPartData left_leg_foot = left_leg.addChild(
                                "left_leg_foot", ModelPartBuilder.create().uv(40, 53).cuboid(-1.5F, 0.0F, 0.0F, 3.0F,
                                                4.0F, 3.0F, new Dilation(0.0F)),
                                ModelTransform.pivot(0.0F, 5.0F, 0.0F));

                ModelPartData right_leg = body
                                .addChild("right_leg",
                                                ModelPartBuilder.create().uv(52, 16).cuboid(-1.5F, 0.0F, 0.0F, 3.0F,
                                                                5.0F, 3.0F, new Dilation(0.0F)),
                                                ModelTransform.pivot(-2.5F, -9.0F, 1.0F));

                ModelPartData cube_r13 = right_leg.addChild("cube_r13",
                                ModelPartBuilder.create().uv(58, 3).cuboid(-2.0F, -2.0F, 0.0F, 3.0F, 2.0F, 1.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(0.5F, 5.75F, -0.25F, 0.2618F, 0.0F, 0.0F));

                ModelPartData right_leg_foot = right_leg.addChild(
