...
public class EnderchesterModel<T extends Enderchester> extends SinglePartEntityModel<T> {
        ...
        public static final EntityModelLayer A_LIVING_ENDER_CHEST = new EntityModelLayer(
                        Identifier.of(WelcomeToMyWorld.MOD_ID, "a_living_ender_chest"), "main");
        ...
        public static TexturedModelData getTexturedModelData() {
                ...
                ModelPartData a_living_chest = modelPartData.addChild("a_living_chest", ModelPartBuilder.create(),
                                ModelTransform.of(0.0F, 24.0F, 0.0F, 0.0F, -3.098F, 0.0F));

                ModelPartData all_body = a_living_chest
                                .addChild("all_body",
                                                ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, -8.0F, -6.0F, 12.0F,
                                                                7.0F, 12.0F, new Dilation(0.0F)),
                                                ModelTransform.pivot(0.0F, -1.25F, 0.0F));

                ModelPartData all_body_eye = all_body.addChild("all_body_eye", ModelPartBuilder.create().uv(0, 1)
                                .cuboid(-2.0F, -2.0F, -1.25F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                                .uv(2, 7).cuboid(-1.0F, -1.0F, -0.75F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F)),
                                ModelTransform.pivot(0.0F, -4.0F, 7.0F));

                ModelPartData body_fur = all_body.addChild("body_fur", ModelPartBuilder.create(),
                                ModelTransform.pivot(0.0F, -4.0F, -6.0F));

                ModelPartData back2 = body_fur.addChild("back2", ModelPartBuilder.create(),
                                ModelTransform.pivot(6.0F, -2.25F, -0.75F));

                ModelPartData cube_r1 = back2.addChild("cube_r1", ModelPartBuilder.create().uv(46, 54)
                                .cuboid(-1.0F, -2.0F, 0.0F, 1.0F, 3.0F, 0.0F, new Dilation(0.0F))
                                ...
                                .uv(36, 54).cuboid(-12.0F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, new Dilation(0.0F)),
                                ModelTransform.of(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));

                ModelPartData left2 = body_fur.addChild("left2", ModelPartBuilder.create(),
                                ModelTransform.of(-6.75F, -2.25F, 0.0F, 0.0F, 1.5708F, 0.0F));

                ModelPartData cube_r2 = left2.addChild("cube_r2", ModelPartBuilder.create().uv(40, 59)
                                .cuboid(-1.0F, -2.0F, 0.0F, 1.0F, 3.0F, 0.0F, new Dilation(0.0F))
                                ...
                                .uv(36, 62).cuboid(-12.0F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, new Dilation(0.0F)),
                                ModelTransform.of(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));

                ModelPartData right2 = body_fur.addChild("right2", ModelPartBuilder.create(),
                                ModelTransform.of(6.75F, -2.25F, 12.0F, 0.0F, -1.5708F, 0.0F));

                ModelPartData cube_r3 = right2.addChild("cube_r3", ModelPartBuilder.create().uv(54, 59)
                                .cuboid(-1.0F, -2.0F, 0.0F, 1.0F, 3.0F, 0.0F, new Dilation(0.0F))
                                ...
                                .uv(52, 62).cuboid(-12.0F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, new Dilation(0.0F)),
                                ModelTransform.of(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));

                ModelPartData front2 = body_fur.addChild("front2", ModelPartBuilder.create(),
                                ModelTransform.of(-6.0F, -2.25F, 12.75F, 0.0F, 3.1416F, 0.0F));

                ModelPartData cube_r4 = front2.addChild("cube_r4", ModelPartBuilder.create().uv(62, 54)
                                .cuboid(-1.0F, -2.0F, 0.0F, 1.0F, 3.0F, 0.0F, new Dilation(0.0F))
                                ...
                                .uv(52, 54).cuboid(-12.0F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, new Dilation(0.0F)),
                                ModelTransform.of(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));

                ModelPartData tongue = all_body.addChild("tongue", ModelPartBuilder.create().uv(54, 28)
                                .cuboid(-2.0F, 0.25F, 0.0F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
                                ...
                                .uv(44, 25).cuboid(-2.0F, 1.25F, 2.0F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F)),
                                ModelTransform.pivot(0.0F, -10.0F, 6.0F));

                ModelPartData teeths = all_body.addChild("teeths", ModelPartBuilder.create().uv(48, 4)
                                .cuboid(5.0F, -1.0F, -3.0F, 0.0F, 1.0F, 2.0F, new Dilation(0.0F))
                                ...
                                .uv(48, 12).cuboid(2.0F, -2.0F, 5.0F, 2.0F, 2.0F, 0.0F, new Dilation(0.0F)),
                                ModelTransform.pivot(0.0F, -8.0F, 0.0F));

                ModelPartData head = all_body.addChild("head",
                                ModelPartBuilder.create().uv(0, 19).cuboid(-6.0F, -4.0F, 0.0F, 12.0F, 4.0F, 12.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(0.0F, -8.0F, -6.0F, 0.5236F, 0.0F, 0.0F));

                ModelPartData right_horn = head.addChild(
                                "right_horn", ModelPartBuilder.create().uv(12, 43).cuboid(2.1434F, -15.115F, 10.0F,
                                                3.0F, 2.0F, 3.0F, new Dilation(0.0F)),
                                ModelTransform.pivot(0.0F, 9.25F, -4.5497F));

                ModelPartData cube_r5 = right_horn.addChild("cube_r5",
                                ModelPartBuilder.create().uv(48, 14).cuboid(0.5F, -1.5F, -1.5F, 1.0F, 1.0F, 1.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(2.1434F, -15.865F, 12.5F, -0.0177F, -0.0192F, -0.2601F));

                ModelPartData cube_r6 = right_horn.addChild("cube_r6",
                                ModelPartBuilder.create().uv(24, 47).cuboid(-0.5F, -2.5F, -1.5F, 2.0F, 2.0F, 2.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(3.1434F, -14.115F, 12.0F, -0.0185F, -0.0185F, -0.2164F));

                ModelPartData left_horn = head.addChild(
                                "left_horn", ModelPartBuilder.create().uv(0, 43).cuboid(-5.0F, -4.0F, 9.0F, 3.0F, 3.0F,
                                                3.0F, new Dilation(0.0F)),
                                ModelTransform.pivot(0.1434F, -2.865F, -3.5497F));

                ModelPartData cube_r7 = left_horn.addChild("cube_r7",
                                ModelPartBuilder.create().uv(44, 45).cuboid(-2.0F, -1.5F, 0.0F, 2.0F, 2.0F, 2.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(-2.5F, -4.0F, 9.5F, 0.0174F, -0.0184F, 0.1725F));

                ModelPartData cube_r8 = left_horn.addChild("cube_r8",
                                ModelPartBuilder.create().uv(48, 10).cuboid(-1.0F, -0.5F, 1.0F, 1.0F, 1.0F, 1.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(-2.75F, -5.75F, 9.0F, 0.0149F, -0.0205F, 0.3034F));

                ModelPartData teeths_head = head.addChild("teeths_head", ModelPartBuilder.create(),
                                ModelTransform.pivot(0.0F, 0.0F, 0.0F));

                ModelPartData head_fur = head.addChild("head_fur", ModelPartBuilder.create(),
                                ModelTransform.pivot(0.0F, 0.0F, 0.0F));

                ModelPartData back = head_fur.addChild("back", ModelPartBuilder.create(),
                                ModelTransform.pivot(6.0F, -2.25F, -0.75F));

                ModelPartData cube_r9 = back.addChild("cube_r9", ModelPartBuilder.create().uv(12, 52)
                                .cuboid(-1.0F, -2.0F, 0.0F, 1.0F, 3.0F, 0.0F, new Dilation(0.0F))
                                ...
                                .uv(0, 52).cuboid(-12.0F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, new Dilation(0.0F)),
                                ModelTransform.of(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));

                ModelPartData right = head_fur.addChild("right", ModelPartBuilder.create(),
                                ModelTransform.of(6.75F, -2.25F, 12.0F, 0.0F, -1.5708F, 0.0F));

                ModelPartData cube_r10 = right.addChild("cube_r10", ModelPartBuilder.create().uv(30, 54)
                                .cuboid(-1.0F, -2.0F, 0.0F, 1.0F, 3.0F, 0.0F, new Dilation(0.0F))
                                ...
                                .uv(18, 55).cuboid(-12.0F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, new Dilation(0.0F)),
                                ModelTransform.of(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));

                ModelPartData left = head_fur.addChild("left", ModelPartBuilder.create(),
                                ModelTransform.of(-6.75F, -2.25F, 0.0F, 0.0F, 1.5708F, 0.0F));

                ModelPartData cube_r11 = left.addChild("cube_r11", ModelPartBuilder.create().uv(26, 61)
                                .cuboid(-1.0F, -2.0F, 0.0F, 1.0F, 3.0F, 0.0F, new Dilation(0.0F))
                                ...
                                .uv(14, 62).cuboid(-12.0F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, new Dilation(0.0F)),
                                ModelTransform.of(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));

                ModelPartData front = head_fur.addChild("front", ModelPartBuilder.create(),
                                ModelTransform.of(-6.0F, -2.25F, 12.75F, 0.0F, 3.1416F, 0.0F));

                ModelPartData cube_r12 = front.addChild("cube_r12", ModelPartBuilder.create().uv(12, 61)
                                .cuboid(-1.0F, -2.0F, 0.0F, 1.0F, 3.0F, 0.0F, new Dilation(0.0F))
                                ...
                                .uv(0, 62).cuboid(-12.0F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, new Dilation(0.0F)),
                                ModelTransform.of(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));

                ModelPartData leg_front_right = a_living_chest.addChild("leg_front_right", ModelPartBuilder.create(),
                                ModelTransform.pivot(6.0F, -3.25F, 4.0F));

                ModelPartData cube_r13 = leg_front_right.addChild("cube_r13",
                                ModelPartBuilder.create().uv(0, 35).cuboid(0.0F, -3.0F, -2.0F, 3.0F, 5.0F, 3.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(-0.75F, 1.5F, 0.0F, 0.0658F, -0.0218F, -0.0813F));

                ModelPartData leg_front_left = a_living_chest.addChild("leg_front_left", ModelPartBuilder.create(),
                                ModelTransform.pivot(-6.0F, -3.25F, 4.0F));

                ModelPartData cube_r14 = leg_front_left.addChild("cube_r14",
                                ModelPartBuilder.create().uv(12, 35).cuboid(-2.0F, -2.0F, -1.0F, 3.0F, 5.0F, 3.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(-0.25F, 0.25F, 0.0F, 0.0344F, 0.0317F, 0.1205F));

                ModelPartData leg_back_right = a_living_chest.addChild("leg_back_right", ModelPartBuilder.create(),
                                ModelTransform.pivot(6.0F, -3.25F, -4.0F));

                ModelPartData cube_r15 = leg_back_right.addChild("cube_r15",
                                ModelPartBuilder.create().uv(24, 35).cuboid(-1.0F, -2.0F, -2.0F, 3.0F, 5.0F, 3.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(0.0F, 0.25F, 0.0F, -0.0855F, -0.0173F, -0.17F));

                ModelPartData leg_back_left = a_living_chest.addChild("leg_back_left", ModelPartBuilder.create(),
                                ModelTransform.pivot(-6.0F, -3.25F, -4.0F));

                ModelPartData cube_r16 = leg_back_left.addChild("cube_r16",
                                ModelPartBuilder.create().uv(36, 35).cuboid(-3.0F, -2.0F, -1.0F, 3.0F, 5.0F, 3.0F,
                                                new Dilation(0.0F)),
                                ModelTransform.of(0.5F, 0.25F, 0.0F, -0.0399F, 0.0089F, 0.146F));
        ...
        public void setAngles(T entity, float limbAngle, float limbDistance, float animationProgress, float headYaw,
                ...
                this.updateAnimation(entity.mouthOpenAnimationState, EnderchesterAnimations.MOUTH_OPEN,
                                animationProgress, 1f);
                this.updateAnimation(entity.mouthCloseAnimationState, EnderchesterAnimations.MOUTH_CLOSE,
                                animationProgress, 1f);
