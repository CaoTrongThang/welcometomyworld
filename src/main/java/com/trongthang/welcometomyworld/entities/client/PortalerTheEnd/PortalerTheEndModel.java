...
import com.trongthang.welcometomyworld.entities.client.Portaler.PortalerAnimations;
...
public class PortalerTheEndModel<T extends Portaler> extends SinglePartEntityModel<T> {
    ...
    public PortalerTheEndModel(ModelPart root) {
