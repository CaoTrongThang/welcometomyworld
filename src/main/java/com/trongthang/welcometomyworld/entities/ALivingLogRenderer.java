...
public class ALivingLogRenderer extends EntityRenderer<ALivingLog> {
    private final BlockRenderManager blockRenderer;

    public ALivingLogRenderer(EntityRendererFactory.Context context) {
        super(context);
        this.blockRenderer = context.getBlockRenderManager();
    }

    @Override
    public void render(ALivingLog entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
        matrices.push();
    ...
    @Override
    public Identifier getTexture(ALivingLog entity) {
