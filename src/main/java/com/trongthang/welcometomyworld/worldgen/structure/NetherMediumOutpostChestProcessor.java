...
public class NetherMediumOutpostChestProcessor extends StructureProcessor {
    public static final Codec<NetherMediumOutpostChestProcessor> CODEC = Codec
            .unit(() -> NetherMediumOutpostChestProcessor.INSTANCE);
    public static final NetherMediumOutpostChestProcessor INSTANCE = new NetherMediumOutpostChestProcessor();
    ...
    public StructureTemplate.StructureBlockInfo process(WorldView world, BlockPos pos, BlockPos pivot,
        ...
        if (currentBlockInfo.state().isOf(Blocks.CHEST)) {
            Identifier lootTable = new Identifier(WelcomeToMyWorld.MOD_ID, "chests/nether_medium_outpost");
