...
public class BlocksEntitiesManager {
        ...
        public static final BlockEntityType<BurningPlankBlockEntity> BURNING_PLANK_BLOCK_ENTITY = Registry.register(
                        Registries.BLOCK_ENTITY_TYPE,
                        new Identifier(WelcomeToMyWorld.MOD_ID, "burning_plank_block_entity"),
                        BlockEntityType.Builder.create(BurningPlankBlockEntity::new, BlocksManager.BURNING_PLANK)
                                        .build(null));

        public static final BlockEntityType<JustACounterBlockEntity> RUSTED_IRON_BLOCK_ENTITY = Registry.register(
                        Registries.BLOCK_ENTITY_TYPE,
                        new Identifier(WelcomeToMyWorld.MOD_ID, "rusted_iron_block_entity"),
                        BlockEntityType.Builder.create(JustACounterBlockEntity::new, BlocksManager.RUSTED_IRON_BLOCK)
                                        .build(null));

        public static final BlockEntityType<VoidBlockEntity> VOID_BLOCK_ENTITY = Registry.register(
                        Registries.BLOCK_ENTITY_TYPE,
